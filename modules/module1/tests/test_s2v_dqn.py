...
from modules.module1.algorithm.s2v_network import Structure2Vec, QFunction, encode_graph, get_graph_embedding
from modules.module1.algorithm.dqn_agent import (
